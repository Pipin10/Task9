...
namespace TugasLab9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void KaryawanReg(string jenis, string nik, string nama, int gajibulanan)
            {
                listKaryawan.Add(new KaryawanReg { Jenis = jenis, NIK = nik, Nama = nama, GajiBulanan = gajibulanan });
            }

            void KaryawanDaily(string jenis, string nik, string nama, int jamkerja, int upah)
            {
                listKaryawan.Add(new KaryawanDaily { Jenis = jenis, NIK = nik, Nama = nama, JumlahJamKerja = jamkerja, UpahPerJam = upah });
            }
            ...
            void tambahdata()
            {
                Console.WriteLine("1. Karyawan Regular\n2. Karyawan Daily\n3. Sales");
                Console.WriteLine();
                ...
                if (submenu == "1")
                {
                    ...
                    string jenis = "Karyawan Regular";

                    KaryawanReg(jenis, nik, nama, gajibulanan);
                }
                else if (submenu == "2")
                {
                    Console.Write("NIK = ");
                    ...
                    string jenis = "Karyawan Daily";

                    KaryawanDaily(jenis, nik, nama, jamkerja, upah);
                }
                else if (submenu == "3")
                {
                    Console.Write("NIK = ");
